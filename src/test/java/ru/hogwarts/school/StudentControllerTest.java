...
public class StudentControllerTest {
    ...
    public void testCreateStudent() {
        ...
        ResponseEntity<Student> response = whenSendingCreateStudentRequest(getUriBuilder()
                .build().toUri(), student);
    ...
    public void testGetStudentById() {
        Student student = givenStudentWith("studentName", 25);
        ResponseEntity<Student> createResponse = whenSendingCreateStudentRequest(getUriBuilder()
                .build().toUri(),student);
    ...
    public void testFindByAge() {
        ...
        Student student_25 = givenStudentWith("studentName3", 25);
        Student student_28 = givenStudentWith("studentName3", 28);
        Student student_32 = givenStudentWith("studentName3", 32);
    ...
    private void thenStudentsAreFoundByCriteria(MultiValueMap<String, String> queryParams, Student... students) {
        ...
        ResponseEntity<Set<Student>> response = restTemplate.exchange(uri,
                HttpMethod.GET, null,
